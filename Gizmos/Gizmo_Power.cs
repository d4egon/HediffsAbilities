...
=======
  ...
  public class Gizmo_Power : Gizmo
  {
      ...
      GizmoRenderParms parms)
    {
      ...
      if (Mouse.IsOver(rect4))
      {
        string str4 = TaggedString.op_Implicit(TranslatorFormattedStringExtensions.Translate("HediffsAbilities.GUI.PowerGain", NamedArgument.op_Implicit(Math.Round((double) this.comp.PowerGain * 1000.0, 2))));
